...
public class QueryPersonalInformationDataAPI {

    @Autowired
    @Qualifier("QueryPersonalInformationDataImplenmentation")
    ...
    public List<Object> queryPersonalInformationData() {
        return adminServiceReadAPI.queryPersonalInformationData();
    }
}
