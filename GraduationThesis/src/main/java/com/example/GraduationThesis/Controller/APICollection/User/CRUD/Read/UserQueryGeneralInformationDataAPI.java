...
public class UserQueryGeneralInformationDataAPI {
    @Autowired
    @Qualifier("UserQueryGeneralInformationDataImplenmentation")
    ...
    public ResponseEntity<Object> queryGeneralInformationData() {
        return userServiceReadAPI.queryGeneralInformationData();
    }
}
