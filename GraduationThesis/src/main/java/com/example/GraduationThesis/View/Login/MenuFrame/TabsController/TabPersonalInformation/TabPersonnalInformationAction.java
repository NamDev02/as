...
public class TabPersonnalInformationAction {
    ...
    public static List<Map<String, Object>> Action() {
        ...
        if (ListRolesManager.getInstance().getRoles().contains(ERole.ROLE_ADMIN.toString())) {
            API = "http://localhost:8080/api/v1/admin/queryPersonalInformationData";
        } else {
            API = "http://localhost:8080/api/v1/user/queryPersonalInformationData";
        }
