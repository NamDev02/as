...
public class TabGeneralInformationAction {
    ...
    public static List<Map<String, Object>> Action() {
        ...
        if (ListRolesManager.getInstance().getRoles().contains(ERole.ROLE_ADMIN.toString())) {
            API = "http://localhost:8080/api/v1/admin/queryGeneralInformationData";
        } else {
            API = "http://localhost:8080/api/v1/user/queryGeneralInformationData";
        }
